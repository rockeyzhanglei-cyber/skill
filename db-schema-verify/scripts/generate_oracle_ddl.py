...
用法：
    python generate_oracle_ddl.py --csv <csv_path> --md <md_path> --mode rebuild --output <output_path>
    python generate_oracle_ddl.py --csv <csv_path> --md <md_path> --mode fix --output <output_path>
